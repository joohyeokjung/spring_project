...
public class ReviewController {
	...
	public ResponseEntity<String> post(@RequestBody ReviewVO rvo) {
		return rsv.register(rvo) > 0 ? new ResponseEntity<String>("1", HttpStatus.OK) :	new ResponseEntity<String>(HttpStatus.INTERNAL_SERVER_ERROR);
	}
	...
	public ResponseEntity<String> erase(@PathVariable("rno") long rno) {
		return rsv.remove(rno) > 0 ? new ResponseEntity<String>("1", HttpStatus.OK) : new ResponseEntity<String>(HttpStatus.INTERNAL_SERVER_ERROR);
	}
}
