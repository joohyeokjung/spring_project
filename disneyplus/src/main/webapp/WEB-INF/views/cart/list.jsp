...
<table class="table table-hover">
	...
	<c:forEach items="${list}" var="cvo">
		<tr>
			<td style="color: white;"><a href="/goods/detail?gno=${cvo.gno}"><img src="/upload/${cvo.goodsImg}" style="width: 80px; height: 96px;"></a></td>
			<td style="color: white; vertical-align: center;"><a style="text-decoration: none; color:white;" href="/goods/detail?gno=${cvo.gno}">${cvo.gname}</a></td>
...
<ul class="pagination justify-content-center py-5">
    ...
    <li class="page-item ${pgn.pgvo.pageNo eq i ? 'active' : ''}" aria-current="page">
