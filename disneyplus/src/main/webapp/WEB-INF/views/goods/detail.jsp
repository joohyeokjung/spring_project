	  ...
	  <div class="carousel-inner">
	  	<c:forEach items="${gfList }" var="gfvo" varStatus="status">
	    	<div class="carousel-item ${status.index eq 0 ? 'active' : ''}">
	      		<img src="/upload/${fn:replace(gfvo.saveDir,'\\','/')}/${gfvo.uuid }_th_${gfvo.fileName}" class="d-block" style="width: 640px; height: 480px">
	    	</div>
	    </c:forEach>
	  </div>
...
<div class="row mt-5 pb-3">
	<c:forEach items="${gfList }" var="gfvo" varStatus="status">
		<img class="mb-5" src="/upload/${fn:replace(gfvo.saveDir,'\\','/')}/${gfvo.uuid }_${gfvo.fileName}" class="d-block w-100">
	</c:forEach>
