    ...
    <ul class="list-unstyled ps-0">
      <li class="mb-1">
        <h5 style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#disney-collapse" aria-expanded="true">
        	디즈니 
        	<span class="my-goods-company">Disney</span><span id="my-more" class="my-more"><i class="fas fa-chevron-down"></i></span>
        </h5>
      ...
      <li class="mb-1">
        <h5 style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#pixar-collapse" aria-expanded="false">
          	픽사 
          	<span class="my-goods-company">Pixar</span><span id="my-more" class="my-more"><i class="fas fa-chevron-down"></i></span>
        </h5>
      ...
      <li class="mb-1">
        <h5 style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#marvel-collapse" aria-expanded="false">
          	마블 
          	<span class="my-goods-company">Marvel</span><span id="my-more" class="my-more"><i class="fas fa-chevron-down"></i></span>
        </h5>
      ...
      <li class="mb-1">
        <h5 style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#starwars-collapse" aria-expanded="false">
          	스타워즈 
          	<span class="my-goods-company">Starwars</span><span id="my-more" class="my-more"><i class="fas fa-chevron-down"></i></span>
        </h5>
      ...
      <li class="mb-1">
        <h5 style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#national-collapse" aria-expanded="false">
          	내셔널지오그래픽 
          	<span class="my-goods-company">National Geographic</span><span id="my-more" class="my-more"><i class="fas fa-chevron-down"></i></span>
        </h5>
      ...
      <li class="mb-1">
        <h5 style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#star-collapse" aria-expanded="false">
          	스타 
          	<span class="my-goods-company">Star</span><span id="my-more" class="my-more"><i class="fas fa-chevron-down"></i></span>
        </h5>
  	...
  	<div class="row">
  		...
  		<div class="col-md-3">
  			<div class="card my-bg" style="width: 13rem;">
  				<a href="/goods/detail?gno=${gvo.gno}&pageNo=${pgn.pgvo.pageNo}&qty=${pgn.pgvo.qty}&company=${gvo.company}&kinds=${gvo.kinds}"><img src="/upload/${gvo.goodsImg}" class="card-img-top"></a>
  				<div class="card-body">
