...
<form action="/goods/register" method="post" enctype="multipart/form-data">
	...
	<span style="position: relative; display: block;" class="mb-3">
		<textarea rows="3" cols="6" class="my-form2" name="description" placeholder="상품 상세 정보" required></textarea>
	</span>
	...
	<span style="position: relative; display: block;" class="mb-3">
		<input type="text" class="my-form" name="price" placeholder="상품 가격" required>
	</span>
	<span style="position: relative; display: block;" class="mb-3">
	...
	<button class="my-btn my-5 w-100" id="regBtn" type="submit">등록하기</button>
</form>
