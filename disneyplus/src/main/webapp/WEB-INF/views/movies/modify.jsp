...
<div class="py-3 px-5 register">
	...
	<form action="/movies/modify" method="post"	enctype="multipart/form-data">
		...
		<div class="mb-3" style="display: inline-block; margin-right: 30px">
			...
			<c:if test="${mvo.movie eq true}">checked</c:if>> 
		...
		<div class="mb-3" style="display: inline-block;">
			...
			<label class="el-switch"> 
			<input type="checkbox" name="movie" value="false" 
			<c:if test="${mvo.movie eq false}">checked</c:if>> 
			<span class="el-switch-style"></span>
			</label>
		</div>
		...
		<span style="position: relative; display: block;" class="mb-3">
			<input type="text" class="my-form" name="media"	value="${mvo.media}">
		</span>
