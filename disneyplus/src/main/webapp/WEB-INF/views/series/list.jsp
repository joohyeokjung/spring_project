...
<sec:authentication property="principal.mvo.authList" var="auths"/>
	...
	<div class="row" id="movieListArea">
		<c:forEach items="${list}" var="mvo">
			<a href="/series/detail?mno=${mvo.mno }&pageNo=${pgn.pgvo.pageNo}&qty=${pgn.pgvo.qty}&genre=${pgn.pgvo.genre}" 
			class="col-md-15-me col-sm-3 my-posters" style="background-image: url(/upload/${mvo.posterImg});"></a>
		</c:forEach>
	</div>
